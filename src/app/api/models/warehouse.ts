...
export interface ResGetApiWarehouseInList {
  items: Array<{goods_name: string, id: number, type_id: string, type_name: string, price: number, in_num: number, in_type: 0 | 1 | 2, in_code: string, in_date: string, goods_id: number}>;
  total: number;
}
...
export interface ResGetApiWarehouseOutList {
  items: Array<{goods_id: number, goods_name: string, type_id: number, type_name: string, out_num: number, out_code: string, out_date: string, id: number, out_cost: number}>;
  total: number;
}
...
export interface ResGetApiWarehouseList {
  items: Array<{goods_id: number, id: number, goods_name: string, type_id: string, type_name: string, cost: number, num: number}>;
  total: number;
}
